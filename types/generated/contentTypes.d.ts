...
export interface ApiExperienceExperience extends Schema.CollectionType {
  ...
  attributes: {
    JobTitle: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Ex:Software Developer'>;
    ...
    JopDescription: Attribute.Blocks;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ProjectScreens: Attribute.Media<'images', true> & Attribute.Required;
...
export interface ApiProjectCategoryProjectCategory
  ...
  attributes: {
    ...
    CategoryDescription: Attribute.Text;
    projects: Attribute.Relation<
      'api::project-category.project-category',
      'manyToMany',
      'api::project.project'
